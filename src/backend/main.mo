...
actor {
  ...
  // Seed: UP Board Subjects per class
  do {
    // Class 6 (UP Board)
    ...
    // Class 11 (UP Board Intermediate - Science/Arts/Commerce)
    ...
    // Class 12 (UP Board Intermediate - Science/Arts/Commerce)
  ...
  // ID Counters (start after seed data)
  var announcementIdCounter = 1;
  var classIdCounter = 13;
  var studentIdCounter = 100;
  var subjectIdCounter = 200;
